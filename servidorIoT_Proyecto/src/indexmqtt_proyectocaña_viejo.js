...
client.on('message', function(topic, message) {
    ...
    if (detectada == 1) { json1["alertas"] = { "quema_detectada": quema_detectada, "quema_controlada": quema_controlada } } else { json1["alertas"] = { "quema_detectada": quema_detectada, "quema_controlada": "no detecto" } }
